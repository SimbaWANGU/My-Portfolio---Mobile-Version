...
projects.forEach((project) => {
  ...
  pHtml.append(document.createTextNode(project.tools[2]));
  const pCss = document.createElement('p');
  pCss.classList.add('technology_text');
  pCss.append(document.createTextNode(project.tools[0]));
  const pJs = document.createElement('p');
  pJs.classList.add('technology_text');
  pJs.append(document.createTextNode(project.tools[1]));
